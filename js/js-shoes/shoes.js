...
function fetchData(url) {//naar json data wordt het veranderd
...
function showShirt(data) {//de rijen en kolommen worden hier bepaald
...
function createRow(shirt) {//de beschrijving wordt hier beschreven van iedere card
